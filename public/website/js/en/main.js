...
// if (bigImage != null) {
// let smImg = document.querySelectorAll(".sml_img img");
// function changeItemImage(img, clas) {
// bigImage.src = img;
// for (let i = 0; i < smImg.length; i++) {
// smImg[i].classList.remove("active");
// }
...
let opt = document.querySelectorAll(".detail .head li");
...
//     );
//     const quantityInputs = document.querySelectorAll(".quantity-num2");

//     quantityMinusButtons.forEach((button) => {
//         button.addEventListener("click", () => {
//             const input = button.previousElementSibling; // Assuming the quantity input is next to the minus button
...
//         button.addEventListener("click", () => {
//             const input = button.nextElementSibling; // Assuming the quantity input is before the plus button
//             const max = parseInt(input.getAttribute("max"));
//             if (parseInt(input.value) < max) {
//                 input.value = parseInt(input.value) + 1;
//                 input.dispatchEvent(new Event("change")); // Trigger change event manually
//             }
//             console.log(input.value); // Optional: log current value for debugging
//             console.log(max); // Optional: log max value for debugging
//         });
//     });
// });
/* -------- quantity --------- */
