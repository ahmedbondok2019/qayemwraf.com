...
// ------------------------------------------------------------//
// Start Scroll Header
const header = document.querySelector(".header"); // Replace 'header' with your actual selector
...
function updateHeaderClass() {
    ...
    if (isScrollingUp) {
        header.classList.remove("active"); // Remove active class on scroll up
    } else if (isScrollingDown) {
        header.classList.add("active"); // Add active class on scroll down
    }
...
// End Scroll Header
// Start Show And Hide To Popup Navigation
if (header !== null) {
    let bars = document.querySelector(".header .head .logo .bars");
    let popupNav = document.querySelector(".navigation");
    let closeNav = document.querySelector(".navigation .close-nav");
    ...
    // End Show And Hide To Popup Navigation
    // Start Show And Hide To PopupCart
    let cart = document.querySelector(".header .cart");
    let popupCart = document.querySelector(".popup-cart");
    let closePopupCart = document.querySelectorAll(".popup-cart .close");

    cart.addEventListener("click", () => {
        popupCart.classList.add("active");
        overLay.style = `display: block`;
    });
    closePopupCart.forEach((close) => {
    ...
    // End Show And Hide To PopupCart

    // Start Show And Hide To PopupAddress
    let address = document.querySelectorAll(
        ".setting .page .location_1 .locations"
    );

    let changeAddress = document.querySelectorAll(
        ".info-payment .content .address .box .change"
    );
    let popupAddress = document.querySelector(".popup-address");

    let closePopupAddress = document.querySelectorAll(".popup-address .close");
    if (address.length > 0 || changeAddress.length > 0) {
        if (address.length > 0) {
            address.forEach((add) => {
                add.addEventListener("click", () => {
                    popupAddress.classList.add("active");
                    overLay.style = `display: block`;
                    document.getElementById("popup-title").innerHTML =
                        add.dataset.title;
                    document.getElementById("url").value = add.dataset.url;
        ...
        if (changeAddress.length > 0) {
            changeAddress.forEach((change) => {
                change.addEventListener("click", () => {
                    popupAddress.classList.add("active");
                    overLay.style = `display: block`;
                    document.getElementById("popup-title").innerHTML =
                        change.dataset.title;
                });
            });
        }

        closePopupAddress.forEach((close) => {
            close.addEventListener("click", () => {
    ...
    // End Show And Hide To PopupAddress

    // Start Show And Hide To PopupaaEditEmail
    let editEmail = document.querySelector(
        ".setting .page .profile-name button"
    );
    if (editEmail !== null) {
        let popupEditEmail = document.querySelector(".popup-edit-email");
        let closePopupEditEmail = document.querySelectorAll(
            ".popup-edit-email .close"
        );
        editEmail.addEventListener("click", () => {
            popupEditEmail.classList.add("active");
            overLay.style = `display: block`;
        });
        closePopupEditEmail.forEach((close) => {
            close.addEventListener("click", () => {
                popupEditEmail.classList.remove("active");
                overLay.style = `display: none`;
            });
        });
        overLay.addEventListener("click", () => {
    ...
    // End Show And Hide To PopupEditEmail

    //-------------------------------------------------//
    //--------------- Start Popup Edit Address ---------------//

    const accordionItems = document.querySelectorAll(".navigation li");

    // Function to toggle accordion items
    const toggleAccordion = (item, content) => {
        const isActive = item.classList.contains("active");

        // Close all other active items at the same level
        const parentList = item.parentElement;
        parentList.querySelectorAll("li.active").forEach((otherItem) => {
            if (otherItem !== item) {
                otherItem.classList.remove("active");
                otherItem.querySelector("ul").style.maxHeight = "0";
            }
        });
    ...
    // Add event listeners to all accordion items (including nested ones)
    accordionItems.forEach((item) => {
        const header = item.querySelector(".parent");
        console.log(header);
        const content = item.querySelector(".child");
        if (header && content) {
...
if (firstElement !== null) {
    const banner = new Swiper(".main-banner", {
        grabCursor: true,
        centeredSlides: true,
        autoplay: {
            delay: 2500,
...
if (document.querySelector('.main-categ') || trackSlider !== null) {
    const swiperMain = new Swiper(".main-categ", {
        grabCursor: true,
    ...
    const swiper = document.querySelector(".slider-wrapper") && new Swiper(".slider-wrapper", {
        grabCursor: true,
        // If we need pagination
        pagination: {
            el: ".swiper-pagination",
    ...
    const swiperl = new Swiper(".slider-wrapper-re", {
        grabCursor: true,
        spaceBetween: 20,
        // If we need pagination
        // pagination: {
    ...
    const swiperPro = new Swiper(".slider-wrapper-ee", {
        grabCursor: true,
        spaceBetween: 20,
        // If we need pagination
        pagination: {
...
// ------------------------------------------------------------//
const accordionItemsFooter = document.querySelectorAll(
    ".footer .content .colum:not(:first-of-type)"
);

accordionItemsFooter.forEach((item) => {
    const header = item.querySelector(".footer .content .colum .descrip");
    header.addEventListener("click", () => {
        const content = item.querySelector(".footer .content .colum ul");
        const activeItem = document.querySelector(
            ".footer .content .colum.active"
        );
...
// --------------------------Start Pass------------------------//
// ------------------------------------------------------------//
let ptn1 = document.querySelector(".page-password .option .ptn1");
let ptn2 = document.querySelector(".page-password .option .ptn2");
let form_email = document.querySelector(".page-password .email");
let form_code = document.querySelector(".page-password .code");
console.log(ptn1);
if (ptn1 !== null) {
    ptn1.addEventListener("click", () => {
        ptn1.classList.add("active");
        ptn2.classList.remove("active");
        form_email.classList.add("active");
        form_code.classList.remove("active");
    });
    ptn2.addEventListener("click", () => {
        ptn2.classList.add("active");
        ptn1.classList.remove("active");
        form_code.classList.add("active");
...
// ------------------------------------------------------------//
// ------------------------------------------------------------//
// -----------------Start Accordion Product Categ--------------//
// ------------------------------------------------------------//
const accordionItemsPro = document.querySelectorAll(
    ".product-categ .side-content > ul > li"
);

accordionItemsPro.forEach((item) => {
...
// ------------------------------------------------------------//
// ------------------End Accordion Product Categ---------------//
// ------------------------------------------------------------//
// ------------------------------------------------------------//
// -------------------Start Popup Product Categ----------------//
// ------------------------------------------------------------//
let sideContent = document.querySelector(".product-categ .side-content");
let btnSideContent = document.querySelector(
    ".product-categ .btn-side p:first-of-type"
);
let closeSideContent = document.querySelectorAll(".product-categ .close");
if (sideContent !== null) {
    btnSideContent.addEventListener("click", () => {
        sideContent.classList.add("active");
        overLay.style = `display: block`;
    });
    closeSideContent.forEach((close) => {
        close.addEventListener("click", () => {
...
// ------------------------------------------------------------//
// --------------------End Popup Product Categ-----------------//
// ------------------------------------------------------------//
const accordionItemsFoote = document.querySelectorAll(".quez");

accordionItemsFoote.forEach((item) => {
    const header = item.querySelector(".quez h4");
    header.addEventListener("click", () => {
        const content = item.querySelector(".quez .content");
        const activeItem = document.querySelector(".quez.active");

        if (activeItem && activeItem !== item) {
            activeItem.classList.remove("active");
            activeItem.querySelector(".quez .content").style.maxHeight = "0";
        }
        item.classList.toggle("active");
        content.style.maxHeight = item.classList.contains("active")
            ? content.scrollHeight + "px"
...
////////////////////// Change Flash Sale Image In any Screens ///////////////
function alterClass() {
    const ww = window.innerWidth;
    const flashSaleBanner = document.getElementById("flash_sale_banner");
    if (flashSaleBanner !== null) {
        if (ww < 768) {
            flashSaleBanner.src = "/website/images/flash_mobile.png";
        } else if (ww >= 768) {
            flashSaleBanner.src = "/website/images/flash_web.png";
        }
    }
}
...
////////////////////// Pop Newletter ///////////////
function popup() {
    const popupElements = document.querySelectorAll(".popup-newsletter");

    popupElements.forEach((popup) => {
        const wrapper = popup.closest(".wrapper");
        const overlay = wrapper.querySelector(".overlay");
        const closeButtons = popup.querySelectorAll("span");
...
/////////////////// Item Details ///////////////////////
//click
let des = document.querySelector(".product-descrip .description");
let data = document.querySelector(".product-descrip .data");
let opt = document.querySelectorAll(".product-descrip .head li");

for (let i = 0; i < opt.length; i++) {
    opt[i].addEventListener("click", () => {
        if (opt[i].dataset.opt == "des") {
...
document.addEventListener("DOMContentLoaded", () => {
    const cards = document.querySelectorAll(".card-using-cart");

    cards.forEach((card) => {
        const cardCart = card.querySelector(".icon-cart");
        const mainCart = card.querySelector(".main-cart");
        const trashCan = card.querySelector(".fa-trash-can");
        ...
        let value = parseInt(numberInput.value, 10) || 1;

        const updateUI = () => {
            numberInput.value = value;
            numberInput.setAttribute("value", value);
            decrementBtn.style.display = value !== 1 ? "block" : "none";
            trashCan.style.display = value === 1 ? "block" : "none";
        };
...
/* -------- video ------------------- */
let PopupVideo = document.querySelector(
    ".product-details .info-product .popup-video"
);
let BtnVideo = document.querySelector(
...
if (PopupVideo !== null) {
    ...
    document.querySelector(".popup-video i").addEventListener("click", () => {
...
////////////////////  login page  ///////////////
let inputs_log = document.querySelectorAll(".input_log");
let labels_log = document.querySelectorAll(".label_log");

// page password for label animation
inputs_log.forEach((input, num) => {
    labels_log.forEach((label, i) => {
        if (num == i) {
            label.addEventListener("click", () => {
                label.style =
                    "top: -10.2px; font-size: 14px; background-color: white; padding: 2px 5px;";
                input.focus();
            });
...
let label_pass = document.querySelector(".label_pass");

if (input_pass !== null && label_pass !== null) {
    // page password for label animation
    label_pass.addEventListener("click", () => {
        label_pass.style =
            "top: -10.2px; font-size: 14px; background-color: white; padding: 2px 5px;";
        input_pass.focus();
    });
...
////////////////////  register page  ///////////////
let inputs = document.querySelectorAll(".input .input_regs");
let labels = document.querySelectorAll(".input label");

if (inputs !== null && labels !== null) {
    // page register for label animation
    inputs.forEach((input, num) => {
        labels.forEach((label, i) => {
            if (num == i) {
                input.addEventListener("focus", () => {
                    label.style = "top: -10px; font-size: 10px";
                });
                input.addEventListener("blur", () => {
                    if (input.value == "") {
                        label.style = "top: 8px; font-size: 16px";
                    } else {
                        label.style = "top: -10px; font-size: 10px";
                    }
                });
