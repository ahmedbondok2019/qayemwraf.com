...
class ProductsCategoryExport implements FromView
{
    public function view(): View
    {
        return view('export_all', [
            // 'products' => Product::active()->whereHas('translations')->get(),
            'products' => Product::whereHas('translations')->get(),
