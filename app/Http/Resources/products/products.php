    ...
    public function toArray($request)
    {
        ...
        */
        ...
        if (isset($this->translations) && $this->translations['lang_id'] == $lang) {
            $storeName = optional(Vendor::find($this->vendor_id))->name;
            $discount = 0;
            if ($salePrice * $rate > 0) {
                $discount = (floatval($this->price) - floatval($salePrice)) / floatval($this->price) * 100;
            }
            ...
            return [
                ...
                'description' => strip_tags($this->translations['description']),
                'category_id' => $category_id,
                'category' => $category,
                'store_name' => $storeName == 'admin' ? 'souqelmlabes' : $storeName,
