...
class UserController extends ApiController
{
    ...
    public function CreateUser(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'permission_sms' => 'nullable|boolean',
            'permission_email' => 'nullable|boolean',
            'permission_phone_call' => 'nullable|boolean',
        ...
        $user->customer_group = $request->customer_group;
        $user->permission_sms = $request->permission_sms ?? 0;
        $user->permission_email = $request->permission_email ?? 0;
        $user->permission_phone_call = $request->permission_phone_call ?? 0;
        $user->accept = $request->accept ?? 0;
    ...
    public function Update(Request $request)
    {
        ...
        if ($user_type == 1) {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'permission_phone_call' => 'nullable|boolean',
                'accept' => 'nullable|boolean',
                'gift_page_enabled' => 'nullable|boolean',
            ]);
        } else {
    ...
    public static function getUserStatus(Request $request)
    {
        ...
        if (! isset($user)) {
            ...
            return ['result' => false, 'user_id' => null, 'user_type' => $user_type];
        }
    ...
    public function getAllCity(Request $request)
    {
        ...
        $data = City::where('governorate_id', $request->governorate_id ?? $request->area)->active()->get();
    ...
    public function updateAddress(Request $request)
    {
        ...
        if ($address) {
            $address->update([
                ...
                'governorate_id' => $request->governorate_id ?? $address->governorate_id,
