        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn .= '<a href="' . frontend_site_url(route('frontend.products.show', ['id' => $row->id, 'slug' => $row->translation->slug ?? 'product'])) . '" target="_blank" class="btn btn-sm btn-success"><i data-feather="external-link"></i></a>';
