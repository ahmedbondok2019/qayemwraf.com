            ...
            <section class="app-user-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form role="form" action="{{ \LaravelLocalization::localizeUrl('admin-2023/about/update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="3" class="form-control" placeholder="{{ trans_db('dashboard.description') }}" id="description" name="description">{{ optional(optional($about)->AboutTranslation)->description }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="3" class="form-control" placeholder="{{ trans_db('dashboard.mission') }}" name="mission">{{ optional(optional($about)->AboutTranslation)->mission }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="3" class="form-control" placeholder="{{ trans_db('dashboard.vision') }}" name="vision">{{ optional(optional($about)->AboutTranslation)->vision }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="3" class="form-control" placeholder="{{ trans_db('dashboard.history') }}" name="history">{{ optional(optional($about)->AboutTranslation)->history }}</textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9 finish_image">
                                                                    <div class="form-group">
                                                                        <label for="">{{ trans_db('dashboard.Image') }} - <span style="color: red;">(width:382 - height:476)</span></label>
                                                                        <div class="custom-file">
                        ...
                        <br/>
                        <div class="row">
                            @if (isset($about->AboutImages))
                                @foreach($about->AboutImages as $image)
                                    <div class="col-lg-3 m-2">
                                        {{-- <a onclick="return confirm('<?php echo trans_db('dashboard.AreYouSureToDelete'); ?>')" href="{{ \LaravelLocalization::localizeUrl('admin-2023/about/delete/image/' . $image->id) }}"> --}}
                                            <i data-feather='trash'></i>
                                            <img src="{{ asset('website/images/about/' . $image->image) }}" alt="">
                                        {{-- </a> --}}
                                    </div>
                                @endforeach
                            @endif
        ...
        $('#crop').click(function(){
            ...
            canvas.toBlob(function(blob){
                ...
                reader.onloadend = function(){
                    ...
                    var URL = "{{ \LaravelLocalization::localizeUrl('admin-2023/blog/cropSlider') }}";
                    var DATA = {image:base64data,width:'1170',height:'453'};

                    var URL = '{{ \LaravelLocalization::localizeUrl('admin-2023/cropImage') }}';
                    console.log(URL);
                    console.log(DATA);
                    $.ajaxSetup({
                        headers: {
