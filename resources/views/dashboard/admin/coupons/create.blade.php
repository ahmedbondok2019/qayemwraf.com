                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="title" class="form-control" name="title" value="{{ old('title') }}" placeholder="{{ trans_db('dashboard.Title') }}" />
                                                </div>
                                                @error('title')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="code" class="form-control" name="code" value="{{ old('code') }}" placeholder="{{ trans_db('dashboard.Code') }}" required />
                                                </div>
                                                @error('code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                ...
                                                <label for="discount_type">{{ trans_db('dashboard.Discount Type') }}</label>
                                                 <div class="input-group">
                                                    ...
                                                    <select class="form-control" id="discount_type" name="discount_type">
                                                        <option value="percentage" {{ old('discount_type') == 'percentage' ? 'selected' : '' }}>{{ trans_db('dashboard.Percentage') }}</option>
                                                        <option value="fixed" {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>{{ trans_db('dashboard.Fixed') }}</option>
                                                    </select>
                                                </div>
                                                @error('discount_type')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" step="0.01" id="discount_value" class="form-control" name="discount_value" value="{{ old('discount_value') }}" required />
                                                </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" step="0.01" id="max_discount" class="form-control" name="max_discount" value="{{ old('max_discount') }}" />
                                                </div>
                                                @error('max_discount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                         ...
                                         <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" id="valid_from" class="form-control" name="valid_from" value="{{ old('valid_from') }}" />
                                                </div>
                                                @error('valid_from')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" id="valid_until" class="form-control" name="valid_until" value="{{ old('valid_until') }}" />
                                                </div>
                                                @error('valid_until')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" id="usage_limit" class="form-control" name="usage_limit" value="{{ old('usage_limit') }}" />
                                                </div>
                                                @error('usage_limit')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" id="usage_limitation" name="usage_limitation">
                                                        ...
                                                        <option value="all" {{ old('usage_limitation') == 'all' ? 'selected' : '' }}>{{ trans_db('dashboard.All Users') }}</option>
                                                        <option value="once_per_user" {{ old('usage_limitation') == 'once_per_user' ? 'selected' : '' }}>{{ trans_db('dashboard.Once Per User') }}</option>
                                                    </select>
                                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-success">
                                            <input type="checkbox" class="custom-control-input" id="include_shipping" name="include_shipping" value="1" {{ old('include_shipping') ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-success">
                                            <input type="checkbox" class="custom-control-input" id="include_services" name="include_services" value="1" {{ old('include_services') ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="payment_method_id" name="payment_method_id[]" multiple>
                                            @foreach($paymentMethods as $method)
                                                <option value="{{ $method->id }}" {{ (is_array(old('payment_method_id')) && in_array($method->id, old('payment_method_id'))) ? 'selected' : '' }}>
                                                    {{ $method->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="product_id" name="product_id[]" multiple>
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" {{ (is_array(old('product_id')) && in_array($product->id, old('product_id'))) ? 'selected' : '' }}>
