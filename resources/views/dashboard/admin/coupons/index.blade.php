                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans_db('dashboard.Coupons') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">{{ trans_db('dashboard.Coupons List') }}</h4>
                                </div>
                                <div class="card-body mt-2">
                                    <table class="datatables-basic table" id="coupons-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                ...
                                                <th>{{ trans_db('dashboard.Validity') }}</th>
                                        ...
                                        <tbody>
                                            @foreach($coupons as $coupon)
                                                <tr>
                                                    ...
                                                    <td>{{ $coupon->title ?? '-' }}</td>
                                                    <td>
                                                        <span class="badge badge-light-primary">{{ $coupon->code }}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="badge badge-light-info">{{ trans_db('dashboard.Unlimited') }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if($coupon->is_active)
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <form action="{{ route('admin.coupons.destroy', $coupon->id) }}" method="POST" onsubmit="return confirm('{{ trans_db('dashboard.Are you sure?') }}');">
                                                                    @csrf
                                                                    @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            if ($.fn.DataTable.isDataTable('#coupons-table')) {
                $('#coupons-table').DataTable().destroy();
            }
