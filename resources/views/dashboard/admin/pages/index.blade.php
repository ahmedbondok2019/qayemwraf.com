                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans_db('dashboard.Pages') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">{{ trans_db('dashboard.Pages List') }}</h4>
                                </div>
                                <div class="card-body mt-2">
                                    <table class="datatables-basic table" id="pages-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                        ...
                                        <tbody>
                                            @foreach($pages as $page)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($page->image)
                                                            <img src="{{ asset($page->image) }}" alt="img" width="50" class="rounded">
                                                        @else
                                                            <span class="badge badge-light-secondary">{{ trans_db('dashboard.No Image') }}</span>
                                                        @endif
                                                    </td>
                                                    <td>{{ $page->translation->title ?? $page->translations->first()->title ?? 'N/A' }}</td>
                                                    <td>
                                                        @if($page->is_active)
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <form action="{{ route('admin.pages.destroy', $page->id) }}" method="POST" onsubmit="return confirm('{{ trans_db('dashboard.Are you sure?') }}');">
                                                                    @csrf
                                                                    @method('DELETE')
