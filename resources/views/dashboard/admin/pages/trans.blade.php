            ...
            <section class="app-user-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/pages/addPageTrans') }}" method="post" enctype="multipart/form-data" role="form">
                            @csrf

                            <input type="hidden" name="page_id" value="{{ $id }}">
                            @php($maxView = \App\Models\Page::select('view_index')->max('view_index'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                <label for="exampleInputEmail1">{{ trans_db('dashboard.Page_Name') }}</label>
                                                {!! Form::text('title', old('title'), ['placeholder'=> trans_db('dashboard.Page_Name'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Enter ..." name="meta_title">{{ old('meta_title') }}</textarea>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Enter ..." name="meta_keywords">{{ old('meta_keywords') }}</textarea>
                                        </div>
                                    ...
                                    <div class="row p-2 border rounded m-2 bg-light">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <label for="">{{ trans_db('dashboard.Image') }} - <span style="color: red;">(width:310 - height:187)</span></label>
        ...
        $('#crop').click(function(){
            ...
            canvas.toBlob(function(blob){
                ...
                reader.onloadend = function(){
                    ...
                    $.ajax({
                        url:'{{ \LaravelLocalization::localizeUrl('admin-2023/pages/cropSlider') }}',
                        method:'POST',
