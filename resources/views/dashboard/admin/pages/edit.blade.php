                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        @foreach(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            @php
                                                $translation = $page->translations->where('locale', $localeCode)->first();
                                            @endphp
                                            <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ $localeCode }}" role="tabpanel" aria-labelledby="{{ $localeCode }}-tab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="title_{{ $localeCode }}" class="form-control" name="title_{{ $localeCode }}" value="{{ old('title_' . $localeCode, $translation->title ?? '') }}" placeholder="{{ trans_db('dashboard.Name') }}" />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="content_{{ $localeCode }}" class="form-control tinymce-editor" name="content_{{ $localeCode }}" rows="10">{{ old('content_' . $localeCode, $translation->content ?? '') }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="meta_description_{{ $localeCode }}" class="form-control tinymce-editor" name="meta_description_{{ $localeCode }}" rows="3">{{ old('meta_description_' . $localeCode, $translation->meta_description ?? '') }}</textarea>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="meta_keywords_{{ $localeCode }}" class="form-control" name="meta_keywords_{{ $localeCode }}" value="{{ old('meta_keywords_' . $localeCode, $translation->meta_keywords ?? '') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" id="sort_order" class="form-control" name="sort_order" value="{{ old('sort_order', $page->sort_order) }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-1">
                                            @if($page->image)
                                                <img src="{{ asset($page->image) }}" class="img-fluid rounded" alt="Current Image" style="max-height: 200px;">
                                            @else
