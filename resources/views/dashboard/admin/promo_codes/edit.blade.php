                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/promo_code/update') }}"
                                        method="post" enctype="multipart/form-data" role="form">
                                        @csrf

                                        <input type="hidden" name="promo_code_id" value="{{ $details->id }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div
                                                            ...
                                                            <input type="date" id="basic-icon-default-promo_valid_from"
                                                                ...
                                                                value="{{ \Illuminate\Support\Carbon::createFromFormat('Y-m-d H:i:s', $details->promo_valid_from)->format('Y-m-d') }}" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div
                                                            ...
                                                            <input type="date" id="basic-icon-default-promo_valid_to"
                                                                ...
                                                                value="{{ \Illuminate\Support\Carbon::createFromFormat('Y-m-d H:i:s', $details->promo_valid_to)->format('Y-m-d') }}" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div
                                                            ...
                                                            <input type="text" id="basic-icon-default-promo_usage_count"
                                                                ...
                                                                value="{{ $details->promo_usage_count }}" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div
                                                            ...
                                                            <select class="form-control form-select-lg" name="promoType">
                                                                <option value="1"
                                                                    {{ $details->promoType == 1 ? 'selected' : '' }}>
                                                                    {{ trans_db('dashboard.percentage') }}</option>
                                                                <option value="2"
                                                                    {{ $details->promoType == 2 ? 'selected' : '' }}>
                                                                    {{ trans_db('dashboard.fixed') }}</option>
                                                            </select>
                                                            @error('promoType')
                                                                <span class="text-danger error">{{ $message }}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div
                                                            ...
                                                            <select class="form-control form-select-lg"
                                                                ...
                                                                <option value="1"
                                                                    {{ $details->promo_oneUse == 1 ? 'selected' : '' }}>
                                                                    {{ trans_db('dashboard.promo_oneUse') }}</option>
                                                                <option value="2"
                                                                    {{ $details->promo_oneUse == 2 ? 'selected' : '' }}>
                                                                    {{ trans_db('dashboard.Every Order') }}</option>
                                                            </select>
                                                            @error('promoType')
                                                                <span class="text-danger error">{{ $message }}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2-size-lg form-select"
                                                                id="selected_payment_methods"
                                                                name="selected_payment_methods">
                                                                <option value="0"
                                                                    @if ($details->payment_method == 0) selected @endif>
                                                                    {{ trans_db('dashboard.Choose') }}</option>
                                                                <option value="1"
                                                                    @if ($details->payment_method == 1) selected @endif>
                                                                    {{ trans_db('dashboard.Cash') }}</option>
                                                                <option value="2"
                                                                    @if ($details->payment_method == 2) selected @endif>
                                                                    {{ trans_db('website.Fawry') }}</option>
                                                                <option value="3"
                                                                    @if ($details->payment_method == 3) selected @endif>
                                                                    {{ trans_db('dashboard.Paytabs') }}</option>
                                                            </select>
                                                                ...
                                                                @foreach ($products as $product)
                                                                    @if (isset($product->translation->title))
                                                                        <option value="{{ $product->id }}"
                                                                            @if ($product->id == $details->product_id) selected @endif>
