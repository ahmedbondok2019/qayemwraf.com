                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans_db('dashboard.Edit') ?: 'تعديل مشروع' }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-2">
                                        @foreach(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            @php
                                                $trans = $project->translations->firstWhere('locale', $localeCode);
                                            @endphp
                                            <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ $localeCode }}" role="tabpanel" aria-labelledby="{{ $localeCode }}-tab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="title_{{ $localeCode }}" class="form-control" name="title_{{ $localeCode }}" value="{{ old('title_' . $localeCode, $trans->title ?? '') }}" required />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description_{{ $localeCode }}" class="form-control" name="description_{{ $localeCode }}" rows="4">{{ old('description_' . $localeCode, $trans->description ?? '') }}</textarea>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="url" id="link" class="form-control" name="link" value="{{ old('link', $project->link) }}" placeholder="https://..." />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="video" class="form-control" name="video" value="{{ old('video', $project->video) }}" placeholder="https://youtube.com/watch?v=..." />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    {{-- Image Upload --}}
                                    <div class="form-group">
                                        <label for="image">{{ trans_db('dashboard.Image') ?: 'صورة المشروع الرئيسية' }}</label>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="image" name="image" accept="image/*" onchange="previewImage(this, 'imagePreview')" />
                                            <label class="custom-file-label" for="image">{{ trans_db('dashboard.Choose file') ?: 'تغيير الصورة' }}</label>
                                        </div>
                                        ...
                                        <div class="mt-1 text-center">
                                            <img id="imagePreview" src="{{ $project->image ? asset($project->image) : '#' }}" alt="Preview" style="{{ $project->image ? '' : 'display:none;' }} max-width: 100%; height: 180px; object-fit: cover; border-radius: 6px; border: 1px solid #ddd;" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="sort_order" class="form-control" name="sort_order" value="{{ old('sort_order', $project->sort_order) }}" min="0" />
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">
                                        <i data-feather="save"></i> {{ trans_db('dashboard.Save Changes') ?: 'حفظ التعديلات' }}
                                    </button>
                                </div>
                            </div>
                        </div>
