        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ trans_db('dashboard.Wishlist') }} - {{ $user->name }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ trans_db('dashboard.Wishlist') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">{{ trans_db('dashboard.User Wishlist Items') }}</h4>
                            </div>
                            <div class="card-datatable">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center">{{ trans_db('dashboard.No items in wishlist') }}</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
