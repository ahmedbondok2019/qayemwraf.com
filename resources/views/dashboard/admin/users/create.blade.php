...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ trans_db('dashboard.Add New User') }}</h2>
        ...
        <div class="content-body">
            <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="address-repeater">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <button type="submit" class="btn btn-primary btn-block mt-2">{{ trans_db('dashboard.Save') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
