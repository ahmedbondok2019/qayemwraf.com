        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ trans_db('dashboard.Add New Blog Category') }}</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="0">{{ trans_db('dashboard.Inactive') }}</option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="view_index">{{ trans_db('dashboard.Sort Order') }}</label>
                                <input type="number" name="view_index" id="view_index" class="form-control" value="0">
                            </div>
                        </div>
