    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <form class="form" action="{{ route('admin.advertisements.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="title_{{ $localeCode }}" class="form-control" name="title_{{ $localeCode }}" value="{{ old('title_' . $localeCode) }}" placeholder="{{ trans_db('dashboard.Title') }}" />
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="link_{{ $localeCode }}" class="form-control" name="link_{{ $localeCode }}" value="{{ old('link_' . $localeCode) }}" placeholder="{{ trans_db('dashboard.Link') }}" />
                                                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" id="location" name="location">
                                                        <option value="home" {{ old('location') == 'home' ? 'selected' : '' }}>{{ trans_db('dashboard.Home') }}</option>
                                                        <option value="category" {{ old('location') == 'category' ? 'selected' : '' }}>{{ trans_db('dashboard.Category') }}</option>
                                                        <option value="popup" {{ old('location') == 'popup' ? 'selected' : '' }}>{{ trans_db('dashboard.Popup') }}</option>
                                                    </select>
                                                </div>
                                                @error('location')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-6 col-12" id="category_selector" style="display:none;">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="start_at">{{ trans_db('dashboard.Start Date') }}</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input type="date" id="start_at" class="form-control" name="start_at" value="{{ old('start_at') }}" />
                                                </div>
                                                @error('start_at')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" id="end_at" class="form-control" name="end_at" value="{{ old('end_at') }}" />
                                                </div>
                                                @error('end_at')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
