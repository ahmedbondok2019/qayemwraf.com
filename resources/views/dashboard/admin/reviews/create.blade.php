                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/reviews/store') }}" method="post" enctype="multipart/form-data" role="form">
                                        @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group {{ $errors->has('youtube_link') ? 'has-error' : '' }}">
                                                            ...
                                                            {!! Form::text('youtube_link', old('youtube_link'), ['placeholder'=> trans_db('dashboard.youtube_link'),'class' => "form-control" ]) !!}
