            ...
            <section class="app-user-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/reviews/addReviewTrans') }}" method="post" enctype="multipart/form-data" role="form">
                            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('title', old('title'), ['placeholder'=> trans_db('dashboard.review_Name'),'class' => "form-control" ]) !!}
        ...
        $('#crop').click(function(){
            ...
            canvas.toBlob(function(blob){
                ...
                reader.onloadend = function(){
                    ...
                    $.ajax({
                        url:'{{ \LaravelLocalization::localizeUrl('admin-2023/reviews/cropSlider') }}',
                        method:'POST',
