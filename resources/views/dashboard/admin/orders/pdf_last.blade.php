...
{{--    {!! Html::style('admin/app-assets/vendors/css/vendors.min.css') !!}--}}
    ...
    <!-- BEGIN: Theme CSS-->
    {!! Html::style('admin/app-assets/css/bootstrap.css') !!}
    {!! Html::style('admin/app-assets/css/bootstrap-extended.css') !!}
    {!! Html::style('admin/app-assets/css/colors.css') !!}
    {!! Html::style('admin/app-assets/css/components.css') !!}
    {!! Html::style('admin/app-assets/css/themes/dark-layout.css') !!}
    {!! Html::style('admin/app-assets/css/themes/bordered-layout.css') !!}
    {!! Html::style('admin/app-assets/css/themes/semi-dark-layout.css') !!}
    ...
    <style media="all">
        ...
        *{
        ...
        @font-face {
            /*font-family: 'DejaVu Sans', sans-serif;*/
            /*font-family: 'Tajawal', sans-serif;*/
            /*src: url('website/css/fonts/Tajawal-Medium') format('ttf');*/
            /*src: url('website/css/fonts/DejaVuSans') format('ttf');*/
        }
        @font-face {
            /*font-family: 'Helvetica';*/
        ...
        body {
            ...
            font-family: 'XBRiyaz', sans-serif;
            /*font-family: 'DejaVu Sans', sans-serif;*/
            /*src: url('Tajawal-Medium') format('ttf');*/
            /*src: url('website/css/fonts/Tajawal-Medium') format('ttf');*/
        }
        div{
            font-size: 1rem;
        ...
        .td_title { font-size: 15px; width : 200px; padding: 10px 0px}
        .td_data { font-size: 18px; font-weight: 600; text-align: right; padding: 10px 0px}
        .report_title { font-size: 40px; font-weight: 700; text-align: right; padding: 30px 0px ; text-decoration: underline;}
    ...
    <style>
        ...
        .inside_table tr:first-child td:first-child { border-top-left-radius: 10px; }
        .inside_table tr:first-child td:last-child { border-top-right-radius: 10px; }

        .inside_table tr:last-child td:first-child { border-bottom-left-radius: 10px; }
        .inside_table tr:last-child td:last-child { border-bottom-right-radius: 10px; }

        .inside_table tr:first-child td { border-top-style: solid; }
        .inside_table tr td:first-child { border-left-style: solid; }
                        ...
                        <div class="card invoice-preview-card">
                                        ...
                                        <td style="width:60%">
                                            <div>
                                                <div class="logo-wrapper" style="margin-bottom:0 !important">
                                                    <img src="{{ asset('website/images/logo/souqelmlabesvoice_logo" style="width:160px;height:93px;" alt="souqelmlabes Logo">
                                                </div>
                                            </div>
                                        </td>
                                        <td >
                                            <table class="inside_table" style="text-align:left;">
                                                <tr style="background-color: #f7f2ea">
                                                    <td><strong style="font-weight:700 !important">{{ _("dashboard.Invoice") }}:</strong></td>
                                                    <td>#{{ $PdfData->id }}</td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="row invoice-spacing">
                                    <table>
                                        <tr>
                                            <td style="width:60%">
                                                <div>
                                                    <h4 style="margin-bottom:15px;font-weight:bold">Invoice To:</h4>
                                                    <?php $user = \App\Models\User::find($PdfData->user_id); ?>
                                                    @if(isset($user) && $user != null)
                                                        <h4 class="mb-25" style="font-weight:400">{{ trans_db("dashboard.Name") }}: {{ $user->name }}</h4>
                                                        <h4 class="mb-25" style="font-weight:400">{{ trans_db("dashboard.Phone") }}: {{ $user->phone }}</h4>
                                                    @endif
                                                </div>
                                            </td>
                                            ...
                                            <td style="vertical-align: baseline;">
                                                <div>
                                                    <h4 style="margin-bottom:15px;font-weight:bold">{{ trans_db("dashboard.Payment_status") }} :</h4>
                                                    <div>
                                                        <h4 class="mb-25" style="margin-bottom: 3px;font-weight: 400;">
                                                            <span>{{ trans_db("dashboard.Total") }} :</span>
                                                            <span class="result_total_amount">{{ $PdfData->total_amount }} {{ $Currency->currency_sign }}</span>
                                                        </h4>
                                                        <h4 class="mb-25"style="margin-bottom: 3px;font-weight: 400;">
                                                            <span>{{ trans_db("dashboard.Payment_status") }} :</span>
                                                            <span>
                                                        ...
                                                        <h4 class="mb-25" style="margin-bottom: 3px;font-weight: 400;">
                                                            <span>
                                                                {{ trans_db("dashboard.payment_method") }} :
                                                            </span>
                                                            <span>{{ $PdfData->payment_method }}</span>
                                                        </h4>
                                                        <h4 class="mb-25" style="margin-bottom: 3px;font-weight: 400;">
                                                            <span>
                                                                {{ trans_db("dashboard.coupon_code") }} : 
                                                            </span>
                            ...
                            <div class="card-body invoice-padding pt-0">
                                <p class="margin-bottom:-5px">
                                    <strong style="font-weight:700 !important">Invoice Services</strong>
                                </p>
                                {{-- <table class="inside_table" style="text-align:left;">
                                    <tr style="background-color: #f7f2ea">
                                        <td><strong style="font-weight:700 !important">Category</strong></td>
                                        <td><strong style="font-weight:700 !important">Service</strong></td>
                                        <td><strong style="font-weight:700 !important">Cost</strong></td>
                                        <td><strong style="font-weight:700 !important">Quantity</strong></td>
                                        <td><strong style="font-weight:700 !important">Sub total</strong></td>
                                    </tr> --}}
                                                ...
                                                <td style="width: 40%"></td>
                                                    <table class="inside_table" style="text-align:left;">
                                                        <tr style="background-color: #f7f2ea">
                                                            ...
                                                            <td><strong style="font-weight:700 !important">{{ $PdfData->total_amount }} {{ $Currency->currency_sign }}</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong style="font-weight:700 !important">Discount:</strong></td>
                                                            <td><strong style="font-weight:700 !important">{{ $PdfData->discount }} {{ $Currency->currency_sign }}</strong></td>
                                                        </tr>
                                                        @if($PdfData->status == 'partial' || $PdfData->status == '')
                                                            <tr>
                                                                <td><strong style="font-weight:700 !important">Paid:</strong></td>
                                                                <td><strong style="font-weight:700 !important">{{ $PdfData->amount }} {{ $Currency->currency_sign }}</strong></td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                            <td><strong style="font-weight:700 !important">Total:</strong></td>
                                                            <td><strong style="font-weight:700 !important">{{ $PdfData->total_amount - $PdfData->discount - $PdfData->amount }} {{ $Currency->currency_sign }}</strong></td>
                                                        </tr>
...
{!! Html::script('admin/app-assets/js/scripts/pages/app-invoice.js') !!}
