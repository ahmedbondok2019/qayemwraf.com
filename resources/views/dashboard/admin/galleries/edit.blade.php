            ...
            <section class="app-user-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/gallery/update') }}" method="post" enctype="multipart/form-data" role="form">
                            @csrf

                            <input type="hidden" name="view_index" value="{{ $Details->GalleryTranslation->view_index }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group {{ $errors->has('gallery_name') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('gallery_name',  $Details->GalleryTranslation->gallery_name, ['placeholder'=> trans_db('dashboard.GalleryName'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group {{ $errors->has('gallery_location') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('gallery_location', $Details->GalleryTranslation->gallery_location, ['placeholder'=> trans_db('dashboard.GalleryLocation'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group {{ $errors->has('gallery_date') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('gallery_date', $Details->GalleryTranslation->gallery_date, ['placeholder'=> trans_db('dashboard.GalleryDate'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="row">
                                            @foreach($Details->GalleryImages as $image)
                                        ...
                                        <div class="row">
                                            @foreach($Details->GalleryVideos as $video)
                                                <a onclick="return confirm('<?php echo trans_db('dashboard.AreYouSureToDelete'); ?>')" href="{{ \LaravelLocalization::localizeUrl('admin-2023/galleries/delete/video/' . $video->id) }}">
                                        ...
                                        <div class="row">
                                            @foreach($Details->GalleryLinks as $link)
                                                <a onclick="return confirm('<?php echo trans_db('dashboard.AreYouSureToDelete'); ?>')" href="{{ \LaravelLocalization::localizeUrl('admin-2023/galleries/delete/link/' . $link->id) }}">
                                                    <div class="col-lg-3">
                                                        {!! $link->link !!}
                                                    </div>
                                                </a>
