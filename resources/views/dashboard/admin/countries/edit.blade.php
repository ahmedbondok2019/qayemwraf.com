    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <form class="form" action="{{ route('admin.countries.update', $country->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                            ...
                                            <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ $localeCode }}" role="tabpanel" aria-labelledby="{{ $localeCode }}-tab">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="name_{{ $localeCode }}" class="form-control" name="name_{{ $localeCode }}" value="{{ old('name_' . $localeCode, $country->translate($localeCode)->name ?? '') }}" placeholder="{{ trans_db('dashboard.Name') }}" />
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="code" class="form-control" name="code" value="{{ old('code', $country->code) }}" />
                                                </div>
                                                @error('code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label for="phone_code">{{ trans_db('dashboard.Phone Code') }} (e.g. +20)</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input type="text" id="phone_code" class="form-control" name="phone_code" value="{{ old('phone_code', $country->phone_code) }}" />
                                                </div>
                                                @error('phone_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label for="sort_order">{{ trans_db('dashboard.Sort Order') }}</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input type="number" id="sort_order" class="form-control" name="sort_order" value="{{ old('sort_order', $country->sort_order) }}" />
                                                </div>
                                                @error('sort_order')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-success">
                                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $country->is_active ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-1">
                                            @if($country->image)
                                                <img src="{{ asset($country->image) }}" class="img-fluid rounded" alt="Current Flag" style="max-height: 50px;">
                                            @else
