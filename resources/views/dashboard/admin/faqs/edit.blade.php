            ...
            <div class="content-body">
                ...
                <section class="app-user-edit">
                    <div class="card">
                        ...
                        <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/faq/update') }}" method="post" enctype="multipart/form-data" role="form">
                            @csrf

                            <input type="hidden" name="view_index" value="{{ $Details->faqTranslation->view_index }}">
                            <input type="hidden" name="faq_id" value="{{ $id }}">
                            <input type="hidden" name="manager_type" value="{{ $Details->faqTranslation->member_type }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('title',  $Details->faqTranslation->title, ['placeholder'=> trans_db('dashboard.FaqName'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="col-lg-12 manager_only">
                                            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::textarea('description', $Details->faqTranslation->description, ['placeholder'=> trans_db('dashboard.description'),'class' => "form-control" ,'rows'=> 3 , 'id' => 'description' ]) !!}
