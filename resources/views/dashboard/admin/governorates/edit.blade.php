                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.governorates.update', $governorate->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="tab-content">
                                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                        @php
                                                            $translation = $governorate->translations->where('locale', $localeCode)->first();
                                                        @endphp
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="sort_order" class="form-control" name="sort_order" value="{{ old('sort_order', $governorate->sort_order) }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-switch custom-switch-success">
                                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $governorate->is_active ? 'checked' : '' }}>
