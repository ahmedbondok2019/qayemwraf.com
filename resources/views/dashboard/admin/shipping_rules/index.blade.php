                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans_db('dashboard.Shipping Rules') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic table" id="rules-table">
                                    <thead>
                                        <tr>
                                            <th>#</th>
    ...
    <script>
        $(function() {
            var table = $('#rules-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.shipping_rules.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
