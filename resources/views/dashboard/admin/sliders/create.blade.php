                                ...
                                <div class="card-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="subtitle_{{ $localeCode }}" class="form-control" name="subtitle_{{ $localeCode }}" value="{{ old('subtitle_' . $localeCode) }}" placeholder="{{ trans_db('dashboard.Subtitle') }}" />
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="button_text_{{ $localeCode }}" class="form-control" name="button_text_{{ $localeCode }}" value="{{ old('button_text_' . $localeCode) }}" placeholder="{{ trans_db('dashboard.Button Text') }}" />
                                                            </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="link" class="form-control" name="link" value="{{ old('link') }}" placeholder="https://example.com" />
                                        </div>
                                         @error('link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
