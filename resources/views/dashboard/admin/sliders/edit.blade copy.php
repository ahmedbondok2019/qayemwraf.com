                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    <form class="form-validate" role="form" action="{{ \LaravelLocalization::localizeUrl('admin-2023/sliders/updateSlider') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="{{ trans_db('dashboard.Title') }}" value="{{$Details->SliderTranslation->title}}" name="title" id="name" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="email">{{ trans_db('dashboard.Link') }}</label>
                                                    <input type="text" class="form-control" placeholder="https://www.example.com" value="{{$Details->SliderTranslation->link}}" name="link" id="email" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="email">{{ trans_db('dashboard.slug') }}</label>
                                                    <input type="text" class="form-control" placeholder="{{ trans_db('dashboard.slug') }}" value="{{$Details->SliderTranslation->slug}}" name="slug"/>
                                                </div>
                                            </div>
                                            ...
                                            {{-- <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="location" name="location">
                                                        <option value="1" {{ $Details->location == 1 ? "selected" : "" }}>{{ trans_db('dashboard.Top') }}</option>
                                                        <option value="2" {{ $Details->location == 2 ? "selected" : "" }}>{{ trans_db('dashboard.Bottom') }}</option>
                                                    </select>
                                                </div>
                                            </div> --}}
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <img src="{{ asset('website/images/sliders') }}/{{ $Details->SliderTranslation->image }}" alt="" style="height: 200px;width:auto;">
                                                            </div>
                                                        </div>
                                                </div>
                                            </div>
        ...
        $('#crop').click(function(){
            ...
            canvas.toBlob(function(blob){
                ...
                reader.onloadend = function(){
                    ...
                    $.ajax({
                        url:'{{ \LaravelLocalization::localizeUrl('admin-2023/sliders/cropSlider') }}',
                        method:'POST',
