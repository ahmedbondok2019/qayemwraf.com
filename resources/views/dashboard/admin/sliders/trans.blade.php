                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <form class="form-validate" role="form" action="{{ \LaravelLocalization::localizeUrl('admin-2023/sliders/addSliderTrans') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ trans_db('dashboard.Title') }}" value="{{ old('title') }}" name="title" id="name" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="email">{{ trans_db('dashboard.Link') }}</label>
                                            <input type="text" class="form-control" placeholder="https://www.example.com" value="{{ old('link') }}" name="link" id="email" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="email">{{ trans_db('dashboard.slug') }}</label>
                                            <input type="text" class="form-control" placeholder="{{ trans_db('dashboard.slug') }}" value="{{ old('slug') }}" name="slug"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row p-2 border rounded m-2 bg-light">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        <label for="">{{ trans_db('dashboard.Image') }} - <span style="color: red;">(width:1279 - height:290)</span></label>
