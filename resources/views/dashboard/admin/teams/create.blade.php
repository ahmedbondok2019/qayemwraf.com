            ...
            <div class="content-body">
                ...
                <section class="app-user-edit">
                    <div class="card">
                        ...
                        <form action="{{ \LaravelLocalization::localizeUrl('admin-2023/team/store') }}" method="post" enctype="multipart/form-data" role="form">
                            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('facebook_link') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('facebook_link', old('facebook_link'), ['placeholder'=> trans_db('dashboard.facebook_link'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('twitter_link') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('twitter_link', old('twitter_link'), ['placeholder'=> trans_db('dashboard.twitter_link'),'class' => "form-control" ]) !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('instagram_link') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::text('instagram_link', old('instagram_link'), ['placeholder'=> trans_db('dashboard.instagram_link'),'class' => "form-control" ]) !!}
