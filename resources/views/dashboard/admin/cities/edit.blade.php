                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.cities.index') }}">{{ trans_db('dashboard.Cities') }}</a>
                                    </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="tab-content">
                                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                        @php
                                                            $translation = $city->translations->where('locale', $localeCode)->first();
                                                        @endphp
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="name_{{ $localeCode }}" class="form-control" name="name_{{ $localeCode }}" value="{{ old('name_' . $localeCode, $translation->name ?? '') }}" placeholder="{{ trans_db('dashboard.Name') }}" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="governorate_id">{{ trans_db('dashboard.Governorate') }}</label>
                                                    <select class="form-control" id="governorate_id" name="governorate_id">
                                                        ...
                                                        @foreach($governorates as $governorate)
                                                            <option value="{{ $governorate->id }}" {{ old('governorate_id', $city->governorate_id) == $governorate->id ? 'selected' : '' }}>
                                                                {{ $governorate->translation->name ?? $governorate->translations->first()->name ?? '' }} ({{ $governorate->country->translation->name ?? '' }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="sort_order" class="form-control" name="sort_order" value="{{ old('sort_order', $city->sort_order) }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-switch custom-switch-success">
                                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $city->is_active ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 mt-2">
                                                ...
                                                <a href="{{ route('admin.cities.index') }}" class="btn btn-outline-secondary">{{ trans_db('dashboard.Cancel') }}</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
