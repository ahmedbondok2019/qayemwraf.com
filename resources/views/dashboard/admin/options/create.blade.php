                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="name_{{ $localeCode }}"
                                                                ...
                                                                value="{{ old('name_' . $localeCode) }}" required placeholder="{{ trans_db('dashboard.Option Name') }} ({{ $properties['native'] }})" />
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="type" id="type" class="form-control">
                                                            <option value="single">{{ trans_db('dashboard.Single Selection') }}</option>
                                                            <option value="multiple">{{ trans_db('dashboard.Multiple Selection') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
