                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans_db('dashboard.Options') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic table" id="options-table">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans_db('dashboard.Name') }}</th>
                                            <th>{{ trans_db('dashboard.Values') }}</th>
                                            <th>{{ trans_db('dashboard.Type') }}</th>
