                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.flash_sales.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="datetime-local" id="start_at" class="form-control" name="start_at" value="{{ old('start_at') }}" required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="datetime-local" id="end_at" class="form-control" name="end_at" value="{{ old('end_at') }}" required />
                                                    </div>
                                                </div>
                                            </div>
