        ...
        <form method="POST" action="{{ route('password.email') }}" class="auth-form">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input id="email" type="email" class="@error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="{{ trans_db('frontend.Enter your email') }}">
                </div>
                @error('email')
            ...
            <button type="submit" class="auth-btn">
                {{ trans_db('frontend.Send Password Reset Link') }} <i class="fa-solid fa-paper-plane"></i>
            </button>
            
            <div class="auth-footer">
                <p><a href="{{ route('login') }}"><i class="fa-solid fa-arrow-left"></i> {{ trans_db('frontend.Back to Login') }}</a></p>
            </div>
        </form>
    </div>
</div>
