...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            <h3>{{ trans_db('frontend.Create Account') }}</h3>
        ...
        <form method="POST" action="{{ route('register') }}" class="auth-form">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input id="name" type="text" class="@error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="{{ trans_db('frontend.Enter your full name') }}">
                </div>
                @error('name')
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <select id="country_id" name="country_id" class="@error('country_id') is-invalid @enderror" required>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input id="email" type="email" class="@error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="{{ trans_db('frontend.Enter your email') }}">
                </div>
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input id="phone" type="text" class="@error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="tel" placeholder="{{ trans_db('frontend.Enter your phone number') }}">
                </div>
                @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <button type="submit" class="auth-btn">
                {{ trans_db('frontend.Register') }} <i class="fa-solid fa-user-plus"></i>
            </button>
...
<style>
    ...
    html[dir="rtl"] .input-wrapper i.fa-phone {
        right: 1rem;
        left: auto;
    }
